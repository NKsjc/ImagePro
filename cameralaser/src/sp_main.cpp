...
int main(int argc,char ** argv){
    im550_t nav_dev;
        ...
        int loops = 0;
            int inifit = 0;
            int sp_num = 0;
            double Px0[N] = { 0 }, Py0[N] = { 0 };
            double dist_org[N][N] = { 0 }; double dist_loc[N][N] = { 0 };
...
int EX[300] = { 0 };
        ...
        int corner_num[N] = { 0 };
                ...
                double  Px[N] = { 0 }, Py[N] = { 0 };
                        ...
                        int globle_id[N] = { 0 }; int loc_id[N] = { 0 };
                        double rt[4] = { 0 };
                        if (loops>1)
                        {
                            int simular_num = simularfunc(corn_num, sp_num, dist_org, dist_loc, globle_id, loc_id);
                            if (simular_num < 2){ printf("simular_num %d is not enough \n", &simular_num); }
                            if (simular_num >= 2){
